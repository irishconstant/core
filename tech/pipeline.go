...
type Pipeline struct {
	...
	TempGraphHP  ref.TempGraph // Температурный график (ОП) (ограничить в зависимости от способа расчёта темп.коэффициента)
	TempGraphNHP ref.TempGraph // Температурный график (МОП)
